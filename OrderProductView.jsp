...
<form action="http://localhost:8082/OSM/UserDeleteServlet" >
...
<input type= "submit" value = "Delete Order" style="height:60px; width:140px" />
</form>
</center>
<br>
<center>
 <form action=http://localhost:8082/OSM/ConfirmServlet><input type="submit"  value="Order Products"  style="height:60px; width:140px" />
 </form>
 <!-- need to check and see if there is a final order in cart -->
	<form action=http://localhost:8082/OSM/ViewFinalOrderServlet><input type= "submit" value = "View Order" style="height:60px; width:140px" /></form>
